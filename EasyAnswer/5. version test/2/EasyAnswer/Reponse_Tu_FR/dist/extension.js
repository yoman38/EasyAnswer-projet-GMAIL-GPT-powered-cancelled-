              ...
              function fetchReply(data2) {
                return __async(this, null, function* () {
                  ...
                  let waiting = setInterval(function() {
                    compose.body(
                      "<p>Il y a deux façons de répondre : SOIT en appuyant directement sur le bouton "Tu", SOIT en écrivant "rep" suivi de votre consigne, en attendant 7 secondes, puis en appuyant sur "Tu".</p><pre>" + animation[i].replace(/\n/g, "<br>").replace(/\s/g, "&nbsp;") + "</pre>"
                    );
