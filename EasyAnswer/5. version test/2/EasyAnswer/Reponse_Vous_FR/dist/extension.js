        ...
        gmail.tools.add_compose_button(
          ...
          function() {
            ...
            return __async(this, null, function* () {
              ...
              let url = "https://hook.eu1.make.com/1chjrnohmw9hsyevtou9ctptagkrqjes";
                fetchReply(data);
              function fetchReply(data2) {
                return __async(this, null, function* () {
                  ...
                  let waiting = setInterval(function() {
                    compose.body(
                      "<p>Il y a deux façons de répondre : SOIT en appuyant directement sur le bouton "Vous", SOIT en écrivant "rep" suivi de votre consigne, en attendant 7 secondes, puis en appuyant sur "Vous".</p><pre>" + animation[i].replace(/\n/g, "<br>").replace(/\s/g, "&nbsp;") + "</pre>"
                    );
