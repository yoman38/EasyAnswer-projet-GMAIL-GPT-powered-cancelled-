        ...
        gmail.tools.add_compose_button(
          ...
          function() {
            return __async(this, null, function* () {
              ...
              let url = "https://hook.eu1.make.com/1neeuxqjap8pqge4lyxsi2pb6rfbad3v";
                fetchReply(data);
		  ...
		  "◴ DALKIA","◷ DALKIA","◶ DALKIA","◵ DALKIA"
                  ...
                  let waiting = setInterval(function() {
                    compose.body(
                      "<p>Cliquez sans rien écrire pour traduire le mail précédent. Ecrivez ensuite votre mail pour que nous le traduisions en anglais.</p><pre>" + animation[i].replace(/\n/g, "<br>").replace(/\s/g, "&nbsp;") + "</pre>"
                    );
