        ...
        gmail.tools.add_compose_button(
          ...
          function() {
            return __async(this, null, function* () {
             ...
             let url = "https://hook.eu1.make.com/qvg02qpyjo77fv7upyvmht376bz7sea5";
                fetchReply(data);
	...
	const animation = [
		 "◴ DALKIA","◷ DALKIA","◶ DALKIA","◵ DALKIA"
                  ...
                  let waiting = setInterval(function() {
                    compose.body(
                      "<p>Nos commerciaux peuvent se tromper, mais notre équipe de correction ne le fera jamais.</p><pre>" + animation[i].replace(/\n/g, "<br>").replace(/\s/g, "&nbsp;") + "</pre>"
                    );
